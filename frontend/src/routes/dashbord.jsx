...
const Dashboard = () => {
 ...
 useEffect(() => {
  const fetchData = async () => {
    try {
      const responseUser = await axios.get("https://paytm-basics.onrender.com/api/v1/api/v1/user/me", {
        headers: {
      ...
      const responseBalance = await axios.get("https://paytm-basics.onrender.com/api/v1/api/v1/account/balance", {
        headers: {
          authorization: "Bearer " + localStorage.getItem("token")
        }
      });
      ...
      const responseUsers = await axios.get("https://paytm-basics.onrender.com/api/v1/api/v1/user/bulk", {
        headers: {
          authorization: "Bearer " + localStorage.getItem("token")
        }
      });
